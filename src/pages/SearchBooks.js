...
import { IDbookSave, getSavedBookIds } from '../utils/localStorage';
...
const SearchBooks = () => {
  ...
  useEffect(() => {
    return () => IDbookSave(savedBookIds);
  });
  ...
  const saveBookDeal = async (bookId) => {
                ...
                <Card.Body>
                  ...
                  {Auth.loggedIn() && (
                    <Button
                      ...
                      onClick={() => saveBookDeal(book.bookId)}>
